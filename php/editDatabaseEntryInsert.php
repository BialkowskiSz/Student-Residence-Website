...
if (strlen($email_user) > 30)
{
    ...
    echo "<script>setTimeout(\"location.href = \'../editDatabase.php\';\", 3000);</script>";
    exit(0);
}
...
$sql = "UPDATE Student
        SET GradType = '$GradType_user',
        StudentName = '$StudentName_user',
        CourseNo = '$CourseNo_user',
        YearOfCourse = '$YearOfCourse_user',
        Email = '$email_user',
        Password = '$password_user'
        WHERE StudentNo = \"$StudentNo_user\"";
...
printPage("success-message", "Successfully updated user details.");
echo "<script>setTimeout(\"location.href = \'../index.html\';\", 3000);</script>";
?>
